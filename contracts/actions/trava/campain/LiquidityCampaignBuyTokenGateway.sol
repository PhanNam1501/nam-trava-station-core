...
contract LiquidityCampaignBuyTokenGateway is ActionBase, LiquidityCampaignHelper {
    ...
    function _buyToken(
        ...
        require( path[0] == WBNB_ADDR , "IVALID_PATH");

        uint256 amountWBNBBefore = WBNB_ADDR.getBalance(address(this));
       
       // from bnb -> WBNB
        depositWbnb(msg.value);

        uint256 amountWBNBAfter = WBNB_ADDR.getBalance(address(this));
