...
contract LiquidityCampaignRedeem is ActionBase, LiquidityCampaignHelper {
    ...
    function executeAction(
        ...
        (uint256 amountRedeem, bytes memory logData) = _redeem(
            params.stakingPool,
            params.to,
            params.amount
        );
        emit ActionEvent("LiquidityCampaignRedeem", logData);
        return bytes32(amountRedeem);
    }
    ...
    function executeActionDirect(
        ...
        logger.logActionDirectEvent("LiquidityCampaignRedeem", logData);
    }
