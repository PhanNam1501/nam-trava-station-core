...
contract TravaNFTHeuristicFarmingStake is
    ActionBase,
    TravaNFTHeuristicFarmingHelper
{
    ...
    function executeAction(
        ...
        emit ActionEvent("TravaNFTHeuristicFarmingStake", logData);
    ...
    function executeActionDirect(
        ...
        logger.logActionDirectEvent("TravaNFTHeuristicFarmingStake", logData);
    }
    ...
    function _stake(
        ...
        bytes memory logData = abi.encode(_vault, _ids, _level, _from);
