...
/// @title Repay a token a user borrowed from WePiggy
contract WePiggyRepay is ActionBase, WePiggyHelper {
    ...
    function executeAction(
        ...
        emit ActionEvent("WePiggyRepay", logData);
    ...
    function executeActionDirect(
        ...
        logger.logActionDirectEvent("WePiggyRepay", logData);
    }
    ...
    /// @notice Repay a borrowed token from the WePiggy protocol
