...
/// @title Supply a token to an Granary market
contract GranarySupply is ActionBase, GranaryHelper {
    ...
    function executeAction(
        ...
        emit ActionEvent("GranarySupply", logData);
    ...
    function executeActionDirect(
        ...
        logger.logActionDirectEvent("GranarySupply", logData);
    }
    ...
    function _supply(
        ...
        lendingPool.deposit(_tokenAddr, _amount, _onBehalf, GRANARY_REFERRAL_CODE);
