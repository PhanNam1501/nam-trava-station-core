...
/// @title Repay a token a user borrowed from an Granary market
contract GranaryRepay is ActionBase, GranaryHelper {
    ...
    function executeAction(
        ...
        emit ActionEvent("GranaryRepay", logData);
    ...
    function executeActionDirect(
        ...
        logger.logActionDirectEvent("GranaryRepay", logData);
    }
