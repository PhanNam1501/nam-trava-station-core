...
/// @title Withdraw a token from an Granary market
contract GranaryWithdraw is ActionBase, GranaryHelper {
    ...
    function executeAction(
        ...
        emit ActionEvent("GranaryWithdraw", logData);
    ...
    function executeActionDirect(
        ...
        logger.logActionDirectEvent("GranaryWithdraw", logData);
    }
    ...
    /// @notice User withdraws tokens from the Granary protocol
