...
/// @title Borrow a token a from an Granary market
contract GranaryBorrow is ActionBase, GranaryHelper {
    ...
    function executeAction(
        ...
        emit ActionEvent("GranaryBorrow", logData);
    ...
    function executeActionDirect(
        ...
        logger.logActionDirectEvent("GranaryBorrow", logData);
    }
    ...
    /// @notice User borrows tokens from the Granary protocol
