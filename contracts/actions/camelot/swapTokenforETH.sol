...
contract swapTokenforETH is ActionBase {
    struct Params {
        address router;
        address[] path;
        uint256 amountIn;
    ...
    function _swapLiquidity(
        ...
        TokenUtils.pullTokensIfNeeded(_path[0], msg.sender, _amountIn);
        IERC20(_path[0]).approve(_router, _amountIn);
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(_amountIn,_amountOutMin,_path,_to,_referrer,_deadline);
        return _amountIn;
    }
