...
/// @title Withdraw a token from an Valas market
contract ValasWithdraw is ActionBase, ValasHelper {
    ...
    function executeAction(
        ...
        emit ActionEvent("ValasWithdraw", logData);
    ...
    function executeActionDirect(
        ...
        logger.logActionDirectEvent("ValasWithdraw", logData);
    }
    ...
    /// @notice User withdraws tokens from the Valas protocol
