...
/// @title Borrow a token a from an Valas market
contract ValasBorrow is ActionBase, ValasHelper {
    ...
    function executeAction(
        ...
        emit ActionEvent("ValasBorrow", logData);
    ...
    function executeActionDirect(
        ...
        logger.logActionDirectEvent("ValasBorrow", logData);
    }
    ...
    /// @notice User borrows tokens from the Valas protocol
