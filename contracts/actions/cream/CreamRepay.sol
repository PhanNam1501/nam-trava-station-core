...
/// @title Repay a token a user borrowed from Cream
contract CreamRepay is ActionBase, CreamHelper {
    ...
    function executeAction(
        ...
        emit ActionEvent("CreamRepay", logData);
    ...
    function executeActionDirect(
        ...
        logger.logActionDirectEvent("CreamRepay", logData);
    }
    ...
    /// @notice Repay a borrowed token from the Cream finance
