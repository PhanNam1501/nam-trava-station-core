...
/// @title Supply a token to Cream
contract CreamSupply is ActionBase, CreamHelper {
    ...
    function executeAction(
        ...
        emit ActionEvent("CreamSupply", logData);
    ...
    function executeActionDirect(
        ...
        logger.logActionDirectEvent("CreamSupply", logData);
    }
    ...
    /// @notice Supplies a token to the Cream finance
