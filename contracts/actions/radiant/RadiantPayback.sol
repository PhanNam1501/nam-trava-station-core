...
/// @title Payback a token a user borrowed from an Radiant market
contract RadiantPayback is ActionBase, RadiantHelper {
    ...
    function executeAction(
        ...
        emit ActionEvent("RadiantPayback", logData);
    ...
    function executeActionDirect(
        ...
        logger.logActionDirectEvent("RadiantPayback", logData);
    }
    ...
    /// @notice User paybacks tokens to the Radiant protocol
