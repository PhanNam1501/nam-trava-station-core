...
/// @title Withdraw a token from an Radiant market
contract RadiantWithdraw is ActionBase, RadiantHelper {
    ...
    function executeAction(
        ...
        emit ActionEvent("RadiantWithdraw", logData);
    ...
    function executeActionDirect(
        ...
        logger.logActionDirectEvent("RadiantWithdraw", logData);
    }
    ...
    /// @notice User withdraws tokens from the Radiant protocol
