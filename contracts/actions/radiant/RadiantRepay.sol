...
/// @title Repay a token a user borrowed from an Radiant market
contract RadiantRepay is ActionBase, RadiantHelper {
    ...
    function executeAction(
        ...
        emit ActionEvent("RadiantRepay", logData);
    ...
    function executeActionDirect(
        ...
        logger.logActionDirectEvent("RadiantRepay", logData);
    }
