...
/// @title Borrow a token a from an Radiant market
contract RadiantBorrow is ActionBase, RadiantHelper {
    ...
    function executeAction(
        ...
        emit ActionEvent("RadiantBorrow", logData);
    ...
    function executeActionDirect(
        ...
        logger.logActionDirectEvent("RadiantBorrow", logData);
    }
    ...
    /// @notice User borrows tokens from the Radiant protocol
