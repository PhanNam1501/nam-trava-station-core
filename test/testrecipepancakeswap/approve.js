...
describe("Test Pancakeswap", async function () {
  ...
  it("Test marketplace", async () => {
    ...
    console.log("Token price ", (await newMarketplaceContract.getTokenOrder(tokenID))[1])
    ...
    // let txApproveTravaToken = await travaTokenContract.approve(marketPlaceAddr, await travaTokenContract.balanceOf(ownerAcc.address))
